...
contract MUTERRA is Initializable, ERC20Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    __Ownable_init();                 // ✅ без параметров
    _transferOwnership(_owner);       // ✅ переносим право собственности
